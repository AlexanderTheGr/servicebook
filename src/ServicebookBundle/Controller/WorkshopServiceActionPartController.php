...
class WorkshopServiceActionPartController extends Main {
    ...
    public function gettabs($id) {
        ...
        $fields["aftermarketBrand"] = array("label" => "Aftermarket Brand", "disabled" => false, 'type' => "select", 'datasource' => array('repository' => 'ServicebookBundle:AftermarketBrand', 'name' => 'name', 'value' => 'id'));
        $fields["aftermarketCode"] = array("label" => "Aftermarket Code", "disabled" => false);
