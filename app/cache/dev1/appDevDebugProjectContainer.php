...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'eav_attribute.eav_attribute_creator' => 'getEavAttribute_EavAttributeCreatorService',
            ...
            'padam87_attribute_bundle.cache_warmer' => 'getPadam87AttributeBundle_CacheWarmerService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SoftoneBundle', ($this->targetDirs[2].'/Resources/SoftoneBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SoftoneBundle', ($this->targetDirs[3].'\\src\\SoftoneBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => $this->get('padam87_attribute_bundle.cache_warmer'), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 2 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 6 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Connection\CustomConnectionFactory A AppBundle\Connection\CustomConnectionFactory instance.
     */
    protected function getDoctrine_Dbal_ConnectionFactoryService()
    {
        return $this->services['doctrine.dbal.connection_factory'] = new \AppBundle\Connection\CustomConnectionFactory(array());
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postLoad'), $this->get('eav_attribute.eav_attribute_creator'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'partbox2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\AppBundle\\Resources\\config\\doctrine') => 'AppBundle\\Entity', ($this->targetDirs[3].'\\src\\SoftoneBundle\\Resources\\config\\doctrine') => 'SoftoneBundle\\Entity', ($this->targetDirs[3].'\\src\\EavBundle\\Resources\\config\\doctrine') => 'EavBundle\\Entity', ($this->targetDirs[3].'\\src\\AccessBundle\\Resources\\config\\doctrine') => 'AccessBundle\\Entity', ($this->targetDirs[3].'\\src\\EdiBundle\\Resources\\config\\doctrine') => 'EdiBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'AppBundle\\Entity');
        $b->addDriver($a, 'SoftoneBundle\\Entity');
        $b->addDriver($a, 'EavBundle\\Entity');
        $b->addDriver($a, 'AccessBundle\\Entity');
        $b->addDriver($a, 'EdiBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'SoftoneBundle' => 'SoftoneBundle\\Entity', 'EavBundle' => 'EavBundle\\Entity', 'AccessBundle' => 'AccessBundle\\Entity', 'EdiBundle' => 'EdiBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_813ac1a2e6429ae24cbafd1d2f633eac2662bd79fec85d58fab8079e2b463d8e');
    ...
    /**
     * Gets the 'eav_attribute.eav_attribute_creator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \EavBundle\EventListener\EavAttributeCreatorListener A EavBundle\EventListener\EavAttributeCreatorListener instance.
     */
    protected function getEavAttribute_EavAttributeCreatorService()
    {
        return $this->services['eav_attribute.eav_attribute_creator'] = new \EavBundle\EventListener\EavAttributeCreatorListener(__DIR__);
    }
    ...
    /**
     * Gets the 'padam87_attribute_bundle.cache_warmer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \EavBundle\CacheWarmer\EntityAnnotationCacheWarmer A EavBundle\CacheWarmer\EntityAnnotationCacheWarmer instance.
     */
    protected function getPadam87AttributeBundle_CacheWarmerService()
    {
        return $this->services['padam87_attribute_bundle.cache_warmer'] = new \EavBundle\CacheWarmer\EntityAnnotationCacheWarmer($this->get('doctrine'), true);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'SoftoneBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SoftoneBundle/Resources/views'), 'Softone');
        $instance->addPath(($this->targetDirs[3].'\\src\\EavBundle/Resources/views'), 'Eav');
        $instance->addPath(($this->targetDirs[3].'\\src\\AccessBundle/Resources/views'), 'Access');
        $instance->addPath(($this->targetDirs[3].'\\src\\EdiBundle/Resources/views'), 'Edi');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d6f781ce05995f342affcc9bbdb2116ca6afb6c7');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56c6c106a56089.87909079')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SoftoneBundle' => 'SoftoneBundle\\SoftoneBundle',
                'EavBundle' => 'EavBundle\\EavBundle',
                'AccessBundle' => 'AccessBundle\\AccessBundle',
                'EdiBundle' => 'EdiBundle\\EdiBundle',
            ...
            'secret' => 'd6f781ce05995f342affcc9bbdb2116ca6afb6c7',
            'doctrine.dbal.connection_factory.class' => 'AppBundle\\Connection\\CustomConnectionFactory',
            'locale' => 'en',
            ...
            'kernel.secret' => 'd6f781ce05995f342affcc9bbdb2116ca6afb6c7',
