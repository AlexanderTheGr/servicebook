...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'page_load_listener' => 'getPageLoadListenerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'page_load_listener', 1 => 'onKernelRequest'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'partbox', 'user' => 'root', 'password' => 'ki7re45tgr', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\PartsboxBundle\\Resources\\config\\doctrine') => 'PartsboxBundle\\Entity', ($this->targetDirs[3].'\\src\\EavBundle\\Resources\\config\\doctrine') => 'EavBundle\\Entity', ($this->targetDirs[3].'\\src\\AccessBundle\\Resources\\config\\doctrine') => 'AccessBundle\\Entity', ($this->targetDirs[3].'\\src\\EdiBundle\\Resources\\config\\doctrine') => 'EdiBundle\\Entity'));
        ...
        $b->addDriver($a, 'PartsboxBundle\\Entity');
        $b->addDriver($a, 'EavBundle\\Entity');
        $b->addDriver($a, 'AccessBundle\\Entity');
        $b->addDriver($a, 'EdiBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'PartsboxBundle' => 'PartsboxBundle\\Entity', 'EavBundle' => 'EavBundle\\Entity', 'AccessBundle' => 'AccessBundle\\Entity', 'EdiBundle' => 'EdiBundle\\Entity'));
    ...
    /**
     * Gets the 'page_load_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PartsboxBundle\EventListener\PageLoadListener A PartsboxBundle\EventListener\PageLoadListener instance.
     */
    protected function getPageLoadListenerService()
    {
        return $this->services['page_load_listener'] = new \PartsboxBundle\EventListener\PageLoadListener($this->get('security.context'), $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PartsboxBundle/Resources/views'), 'Partsbox');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5679924e70bec8.83253089')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PartsboxBundle' => 'PartsboxBundle\\PartsboxBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'partbox',
            'database_user' => 'root',
            'database_password' => 'ki7re45tgr',
