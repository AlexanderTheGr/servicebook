...
class BrandVinController extends Main {
    ...
    public function getservicetabs($id) {
        ...
        $fields["brandVin"] = array("label" => "Brand", "disabled" => true, "className" => "col-md-6", 'type' => "select", "required" => true, 'datasource' => array('repository' => 'ServicebookBundle:BrandVin', 'name' => 'brandvin', 'value' => 'id'));
